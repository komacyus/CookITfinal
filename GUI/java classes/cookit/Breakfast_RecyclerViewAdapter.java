...
class Breakfast_RecyclerViewAdapter extends RecyclerView.Adapter<Breakfast_RecyclerViewAdapter.MyViewHolder> {
 // BU VARRRRRRRRRRRR
    ...
    @NonNull
    @Override
    public Breakfast_RecyclerViewAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.list_random_recipe, parent, false);

        return new Breakfast_RecyclerViewAdapter.MyViewHolder(view, recyclerViewInterface);
    }

    @Override
    public void onBindViewHolder(@NonNull Breakfast_RecyclerViewAdapter.MyViewHolder holder, int position) {
