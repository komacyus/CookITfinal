...
public class SuggestMeRecipeActivity extends AppCompatActivity implements  RecyclerViewInterface{
    ...
    ArrayList<RecipeModel> cook = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goMarket.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                switchFromSuggestToMore();
            }
        });
    }

    private void switchFromSuggestToMore(){
        Intent x = new Intent(this, SuggestMeMoreActivity.class);
        startActivity(x);
    }
    ...
    @Override
        public void onItemClick(int position) {
            ...
            intent.putExtra("NAME", cook.get(position).getName());
            intent.putExtra("DESCRIPTION", cook.get(position).getDescription());
            intent.putExtra("IMAGE", cook.get(position).getImage());
