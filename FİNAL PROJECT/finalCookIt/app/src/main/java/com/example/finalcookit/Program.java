...
public class Program {
    ...
    public static ArrayList<Recipe> cookableWithExtras;
    public static ArrayList<Recipe> notCookableWithCurrents;
    ...
    public Program() throws IOException {
        ...
        cookableWithCurrents = new ArrayList<>();
        cookableWithExtras = new ArrayList<>();
        notCookableWithCurrents = new ArrayList<>();
    ...
    public void fillIngredientTypesList(Ingredient[] ingredients) throws IOException {
        ...
        ingredients[0] = new Ingredient("Onion", 1, 0, 5, "https://getir.com/en/product/onions-yTzj4LRUG0/");
    ...
    public void fillAllRecipes() {
        ...
        lunchRecipes[0] = new Recipe("Lentil Soup",
                "*3 spoon olive_oil",
                "*1 unit onion",
                "*1 unit carrot",
        ...
        allRecipes[0] = breakfastRecipes[0];
        allRecipes[1] = breakfastRecipes[1];
        allRecipes[2] = lunchRecipes[0];
        allRecipes[3] = lunchRecipes[1];
        allRecipes[4] = dinnerRecipes[0];
        allRecipes[5] = dinnerRecipes[1];
    ...
    public static String toStringCookableWithExtras(){
        ...
        if(cookableWithExtras.isEmpty()){
            ...
            s += "by purchasing only one ingredient !\n\n";
                ...
                String nameRecipe = cookableWithExtras.get(0).getName();
                String nameIng = cookableWithExtras.get(0).getNameOfTheMissingIngToCookThis();
                String url = cookableWithExtras.get(0).getURLofMissingIngToCookThis();
